	...
	export const sidebarMenuButtonVariants = tv({
		...
		variants: {
			variant: {
				...
				outline: "bg-background shadow-[0_0_0_var(--rule-width)_var(--sidebar-border)] hover:bg-sidebar-accent hover:text-sidebar-accent-foreground hover:shadow-[0_0_0_var(--rule-width)_var(--sidebar-accent)]",
			},
			size: {
				default: "h-8 text-sm",
				sm: "h-7 text-xs",
