<script lang="ts" module>
	...
	export const bubbleVariants = tv({
		base: "gap-1 data-[align=end]:self-end max-w-[85%] data-[variant=ghost]:max-w-full group-data-[align=end]/message:self-end group/bubble relative flex w-fit min-w-0 flex-col",
		variants: {
			variant: {
