...
export const ModelManifestSchema = z
  .strictObject({
    ...
    revision: z
      .string()
      .regex(/^[a-f0-9]{40}$/)
      .or(z.literal("public-test-revision")),
    ...
    provenance: z
      .strictObject({
        ...
        conversionLicense: z.literal("Apache-2.0"),
      })
      .optional(),
    runtimeProvenance: z
      .strictObject({ package: z.string(), version: z.string(), license: z.literal("MIT") })
      .optional(),
    artifacts: z
      .array(
        z.strictObject({
...
export const KnownLlamaRuntime: RuntimeArtifact = immutable(
  RuntimeArtifactSchema.parse({
...
export const KnownModelManifests: Readonly<Record<KnownModelId, ModelManifest>> = immutable({
  "qwen3-embedding-0.6b-gguf": ModelManifestSchema.parse({
    ...
    provenance: {
      repository: qwenRepository,
      baseLicense: "Apache-2.0",
      conversionLicense: "Apache-2.0",
    },
    runtimeProvenance: {
      package: "llama.cpp",
      version: "2f539596c6e9a977e91b6bc6344650422c6bc3b0",
      license: "MIT",
    },
    artifacts: [
      {
...
export function knownManifest(model: KnownModelId): ModelManifest {
  return KnownModelManifests[model];
}
