...
} from "../packages/observability/conversation-history/dist/index.js";
...
import { syntheticAgentFixture, codexAgentFixture } from "./agent-conformance-fixtures.mjs";
...
assert.equal(
  HistoryReadBatchSchema.safeParse({ entries: [], checkpoints: [], hasOlder: false }).success,
  true,
);
assert.equal(
