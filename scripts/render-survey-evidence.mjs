...
if (
  ![
    ...
    "evaluation-survey",
    "harness-workbench-survey",
    "knowledge-memory-survey",
  ].includes(survey) ||
  !name ||
  !/^[a-z0-9-]+$/.test(name) ||
  !archify ||
  ...
  throw Error(
    "Usage: node scripts/render-survey-evidence.mjs <survey> <diagram> <archify.mjs> <source-checkout>",
  );
...
console.log(output);
console.log(
  "Browser checks and visual review are separate. Write any new sidecars beside this HTML, never into the archived surveys directory.",
);
