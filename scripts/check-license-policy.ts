...
const selections: Record<string, string> = { "sqlite-vec@0.1.9": "MIT", "sqlite-vec-darwin-arm64@0.1.9": "MIT" };
...
for (const item of inventory.npm) {
  ...
  const result = assessLicense(licence, selections[key], mplReviewed);
