  ...
  registerAppTool(
    ...
    async () => ({
      content: [
        {
          type: "resource_link",
          name: "Shared returned image",
          uri: c.returned + "/redirect.png?signature=SYNTHETIC",
          mimeType: "image/png",
        },
        {
          type: "resource_link",
          name: "Expired image",
          uri: c.returned + "/expired.png",
          mimeType: "image/png",
        },
      ],
    }),
      ...
      workbenches: [
        {
          id: c.id,
          title: c.id,
          description: "Public synthetic media check",
          tools: [],
          skills: [],
        },
      ],
      views: [{ id: c.id + ".view", workbenchId: c.id, title: c.id, entrypoint: uri }],
    },
    servers: [{ name: "media", transport }],
