...
} from "./knowledge-activity-fixture.js";
...
const service: KnowledgeService = {
      ...
      models: [
        {
          ...
          licence: "Apache-2.0",
          source: "https://example.invalid/public-fixture",
          ...
          weightsBytes: 640000000,
          runtimeBytes: 1000000,
  ...
  async download() {
    throw Error("This UI fixture must not download");
  },
